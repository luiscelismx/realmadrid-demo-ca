...
// Convierte las opciones de ordenamiento al formato esperado por la API de commercetools
export const convertToSortOptions = (tableSorting) => {
  if (!tableSorting || !tableSorting.value) return [];
  return [`${tableSorting.value.key} ${tableSorting.value.order}`];
};
